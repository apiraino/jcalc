    ...
    app = ApplicationObject,
        ...
        MUIA_Application_Menustrip,
            ...
            MUIA_Menu_Title, "Project",
              MUIA_Family_Child, menu_about = MenuObject, MUIA_Menu_Title,"About",MUIA_Menuitem_Shortcut,"A",End,
              MUIA_Family_Child, menu_quit = MenuObject, MUIA_Menu_Title,"Quit",MUIA_Menuitem_Shortcut,"Q",End,
            End,

            MUIA_Family_Child, MenuObject,
            MUIA_Menu_Title, "Settings",
              MUIA_Family_Child, menu_history = MenuObject,
                  MUIA_Menu_Title, "Enable history panel",
                  MUIA_Menuitem_Checkit, TRUE,
                MUIA_Menuitem_Checked, FALSE,
                  MUIA_Menuitem_Shortcut, "H",
              End,
              MUIA_Family_Child, menu_csv = MenuObject,
                  MUIA_Menu_Title, "Save history as CSV",
                  MUIA_Menuitem_Checkit, TRUE,
                MUIA_Menuitem_Checked, FALSE,
            ...
            MUIA_Menu_Title, "Base",
              MUIA_Family_Child, menu_bin = MenuObject,
                  MUIA_Menu_Title, "Binary",
                  MUIA_Menuitem_Checkit, TRUE,
                MUIA_Menuitem_Checked, FALSE,
